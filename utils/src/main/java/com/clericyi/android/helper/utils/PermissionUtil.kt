...
object PermissionUtil {
    ...
    fun checkMorePermissions(
        ...
        for (i in permissions.indices) {
            takeIf { !checkPermission(context, permissions[i]) }.apply {
    ...
    fun checkAndRequestPermission(
        ...
        permission: String,
        requestCode: Int
    ) = takeIf { !checkPermission(context, permission) }.apply {
    ...
    fun checkAndRequestMorePermissions(
        ...
        val permissionList = checkMorePermissions(context, permissions).toTypedArray()
    ...
    fun checkMorePermissions(
        ...
        val permissionList =
            checkMorePermissions(context, permissions)
